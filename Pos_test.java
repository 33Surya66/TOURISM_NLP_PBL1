...
public class Pos_test {
    ...
    public static void main(String[] args) {
        try {
            // Load the Excel file
            FileInputStream fis = new FileInputStream("D:\\scr\\src\\main\\resources\\test_final.xlsx");
            ...
            // Calculate accuracy by comparing with the expected overall positivity ratio
            double expectedPositivityRatio = 0.5;
            double accuracy = 100 - Math.abs(positivityRatio - expectedPositivityRatio) *100;
